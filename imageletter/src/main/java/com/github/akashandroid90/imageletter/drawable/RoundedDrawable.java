package com.github.akashandroid90.imageletter.drawable;
...
public class RoundedDrawable extends Drawable {
    ...
    public RoundedDrawable(Bitmap bitmap) {
        ...
        if(mBorderColor!=null){
            ...
            else mBorderPaint.setColor(mBorderColor.getDefaultColor());
        } else mBorderPaint.setColor(DEFAULT_BORDER_COLOR);
    ...
    public int getBorderColor() {
        ...
        else return DEFAULT_BORDER_COLOR;
    }
